...
val f: ('a list -> 'b) -> 'b = fn;
\end{lstlisting}
En este caso, el intérprete original de ML indica un conflicto: \verb|`Circular type results from unifying 'a and 'a list -> 'b"'|. Sin embargo, en MLOR no realizamos detección de aplicaciones circulares en funciones, por lo que este caso da una respuesta errónea.
...
El tipo de la función g debería ser: \verb|'a -> 'b -> (('a * int list) * 'b) = fn|.

Por último, se presentan problemas con expresiones del tipo:
