...
\section{Métodos}
\begin{enumerate}
	\item \textbf{tipoMásEspecífico}: Devuelve el tipo más específico entre los dos parámetros, si es que son compatibles. En el caso de los tipos estructurados (listas, tuplas y funciones), se llama recursivamente. Este método también corrige las referencias de las variables, directa e indirectamente. 
